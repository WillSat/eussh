export default {
  ...
  overview: { title: '服务器总览', openTerminal: '打开终端', fileManager: '文件', cpu: 'CPU', memory: '内存', storage: '磁盘', timezone: '时区', uptime: '运行时间', latency: '延迟', host: '主机', cores: '核', location: '服务器位置', swap: '交换', none: '无', locationUnavailable: '位置不可用', loading: '加载中...', copy: '复制', copied: '✓ 已复制' },
