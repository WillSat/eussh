export default {
  ...
  status: { noServer: '未选择服务器', connecting: '连接中...', error: '连接错误', disconnected: '已断开', connected: '已连接', terminals: '{count} 个终端', latency: '{ms}ms', uploaded: '↑ {name} 上传成功', downloaded: '↓ {name} 已下载' },
